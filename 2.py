...
plt.hist(rec_times_1, bins=bins_1, color='b', alpha=.5, label='$t_{rec}$, $b_n=.1, d_n=.2$', density=True, log=True)
plt.hist(inf_times_1, bins=bins_1, color='r', alpha=.5, label='$t_{inf}$, $b_n=.1, d_n=.2$', density=True, log=True)
plt.ylabel('log(density)')
plt.legend(fontsize=10)

plt.subplot(3,1,2)
plt.hist(rec_times_2, bins=bins_2, color='b', alpha=.5, label='$t_{rec}$, $b_n=1, d_n=2$', density=True, log=True)
plt.hist(inf_times_2, bins=bins_2, color='r', alpha=.5, label='$t_{inf}$, $b_n=1, d_n=2$', density=True, log=True)
plt.ylabel('log(density)')
plt.legend(fontsize=10)

plt.subplot(3,1,3)
plt.hist(rec_times_3, bins=bins_3, color='b', alpha=.5, label='$t_{rec}$, $b_n=10, d_n=5$', density=True, log=True)
plt.hist(inf_times_3, bins=bins_3, color='r', alpha=.5, label='$t_{inf}$, $b_n=10, d_n=5$', density=True, log=True)
plt.xlabel('Time')
plt.ylabel('log(density)')
plt.legend(fontsize=10)
plt.show()
