...
plt.figure()
plt.plot(S[:,30]-I[:,30], linewidth=2, label='$S-I$')
plt.axhline(S[n_iters-10,30], linewidth=2, linestyle='--', c='r', label='Steady state')
...
plt.figure()
plt.plot(S[300, :] - I[300, :], linewidth=2, label='$S-I$')
plt.plot(I[300, :], linewidth=2, label='$I$', linestyle='-.')
plt.plot(S[300, :], linewidth=2, label='$S$', linestyle='--')
#plt.axhline(S[n_iters - 10, 30], linewidth=3, linestyle='--', c='r', label='Steady state')
plt.xlabel('Time [dt]', fontsize=15)
plt.ylabel('Individuals', fontsize=15)
plt.title('$S-I$ vs. habitat at $t=$%.1fdt'%300, fontsize=17)
plt.legend()
plt.show()
